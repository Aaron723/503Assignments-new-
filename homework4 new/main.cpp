...
int delete_item_position(int[20], int, int);
int delete_item_isbn(int[20], int, int);
    ...
    while (i != 0)
    {
        ...
        switch (i)
        {
            ...
            case 5:			//delete a book using it's position, after that, print booklist.
                int position5,del_bool;
                cout << "Please enter the position of the book" << endl;
                cin >> position5;

                del_bool=delete_item_position(book_list, counter, position5);
                if(del_bool!=-1)
                {
                    counter--;
                }
            ...
            case 6:			//delete a book using it's ISBN number, after that, print booklist.
                ...
                cout << "Please enter the ISBN number" << endl;
                cin >> ISBN6;
                del_bool1=delete_item_isbn(book_list, counter, ISBN6);
                if(del_bool1!=-1)
                {
                    counter--;
                }
...
int delete_item_position(int book_list[20], int counter, int position)
{
    if (position >= counter)
    {
        cout << "This book is not in the list!" << endl;
...
int delete_item_isbn(int book_list[20], int counter, int ISBN)
{
    int position = -1;
